...
const createCategory = asyncHandler(async (req, res) => {
  const category = await categoryService.createCategory(categoryDto.toCreateCategoryRequestDto(req.body));
...
const updateCategory = asyncHandler(async (req, res) => {
  ...
  const category = await categoryService.updateCategory(id, categoryDto.toUpdateCategoryRequestDto(req.body));
