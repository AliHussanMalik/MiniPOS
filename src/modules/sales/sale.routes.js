...
router.post("/", authorize(...STAFF_ROLES), validate(createSaleSchema), saleController.createSale);
router.get("/", authorize(...STAFF_ROLES), saleController.getSales);
router.get("/my", authorize(...STAFF_ROLES, ...CUSTOMER_ROLES), saleController.getOwnSales);
router.get("/:id", authorize(...STAFF_ROLES), saleController.getSaleById);
router.put("/:id", authorize(...STAFF_ROLES), validate(updateSaleSchema), saleController.updateSale);
router.delete("/:id", authorize(...STAFF_ROLES), saleController.deleteSale);
